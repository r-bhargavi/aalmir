odoo.define('gt_sale_pricelist.dashboard', function (require) {
"use strict";
...
var SalesTeamDashboardView = KanbanView.extend({
    ...
    render: function() {
        ...
        return this.fetch_data().then(function(result){
            ...
            alert(result.keys());
            var sales_dashboard = QWeb.render('gt_sale_pricelist.SalesDashboard', {
                widget: self,
    ...
    on_dashboard_action_clicked: function(ev){
        ...
        } else if (action_name === 'calendar.action_calendar_event_task') {
            additional_context['search_default_task_list'] = 1;
        } else if (action_name === 'calendar.action_calendar_event_call') {
            additional_context['search_default_rem_list'] = 1;
        }
