...
#    _rec_name = 'name'
    ...
    name  = fields.Char('Report Title',default='Invoice Submission')
    ...
    def summary_value(self):
		...
		#record.product_ids=[(6,0,product_id)]
            ...
            if record.product_status =='sale':
            ...
            elif self._context.get('invoice') or record.product_status =='invoice':
                if record.date_from and record.date_to:
                ...
                domain +=[('invoice_id.state','in',('open','paid'))]
                if product_id:
                ...
                if record.report_type == 'summary':
                    ...
                    print "val----------------------",val
                    record.product_line=val
            elif record.product_status =='delivery':
                if record.date_from and record.date_to:
