odoo.define('web.crash_manager', function (require) {
    var CrashManagerpettools = require('web.CrashManagerpettools');
    return new CrashManagerpettools();
});

odoo.define('web.CrashManagerpettools', function (require) {
"use strict";
...
var CrashManagerpettools = core.Class.extend({
    init: function() {
        this.active = true;
    },
    enable: function () {
    ...
    show_warning: function(error) {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "Warning", //(_.str.capitalize(error.type) || _t("Warning")),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "Warning",//(_.str.capitalize(error.type) || "Warning"),
            buttons: [
